...
YIELD_POLICY_RATE_WEIGHT = P(
    ...
    "\n"
    "IT DID NOT UNBLOCK 5.1. That was claimed when this parameter landed and "
    "it is wrong: 5.1 was rebuilt on top of it and `overheating` still stops "
    "hyperinflating (3.83% against 380.50%). The previous pass measured 3.13% "
    "with the OLD yield, so both fail and the missing Fisher term was never "
    "the cause — see open_items A6. This fix stands on its own merits.\n"
    "\n"
